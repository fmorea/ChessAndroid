...
public class NetworkHandler {
    ...
    private void notifyConnected() { mainHandler.post(() -> { for (NetworkListener l : listeners) l.onConnected(); }); }
    private void notifyDisconnected() { mainHandler.post(() -> { for (NetworkListener l : listeners) l.onDisconnected(); }); }
    private void notifyMessage(String msg) { mainHandler.post(() -> { for (NetworkListener l : listeners) l.onMessage(msg); }); }
